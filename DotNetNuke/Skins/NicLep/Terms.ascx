<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Terms.ascx.cs" Inherits="SDDotNet.DNN.Skins.NicLep.Terms" %>
...
<dnn:DnnJsInclude ID="DnnJsInclude4" runat="server" FilePath="Resources/js/sd.dnn.skin.js" PathNameAlias="SkinPath"   />
